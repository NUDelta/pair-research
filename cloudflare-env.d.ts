/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings ./cloudflare-env.d.ts` (hash: 393f6d061e7f83d17e9fa42391116cba)
...
interface __BaseEnv_CloudflareBindings {
	...
	DATABASE_URL: string;
	GROUP_SESSION_SIGNING_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_TURNSTILE_SECRET_KEY" | "CONTACT_ADMIN_EMAIL" | "CONTACT_FROM_EMAIL" | "DATABASE_URL" | "GROUP_SESSION_SIGNING_SECRET" | "RESEND_API_KEY" | "SUPABASE_SECRET_KEY">> {}
}
