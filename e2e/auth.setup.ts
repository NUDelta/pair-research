...
import { authStorageStatePath, enableTurnstileBypass, requirePlaywrightAuthCredentials } from './helpers/auth'

const authCredentials = requirePlaywrightAuthCredentials()
